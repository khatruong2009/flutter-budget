...
void main() {
  group('EmptyState Widget Tests', () {
    testWidgets('renders with default noData state',
      ...
      expect(
          find.text('Get started by adding your first item'), findsOneWidget);

      // Verify icon is displayed
      expect(find.byIcon(CupertinoIcons.tray), findsOneWidget);
    });

    testWidgets('renders with default noResults state',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets('renders with default error state',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
      ...
      expect(find.text('We encountered an error. Please try again'),
          findsOneWidget);
    ...
    testWidgets('renders with custom title and message',
        (WidgetTester tester) async {
    ...
    testWidgets('renders with gradient icon container',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
      ...
      for (final sizedBox in sizedBoxWidgets) {
        if (sizedBox.height != null) {
          ...
          expect(validSpacings.contains(sizedBox.height), true,
              reason:
                  'SizedBox height ${sizedBox.height} should use design system spacing');
        }
      }
    });
    ...
    testWidgets('all empty state types have correct default icons',
        (WidgetTester tester) async {
      // Test noData type
      await tester.pumpWidget(
        MaterialApp(
